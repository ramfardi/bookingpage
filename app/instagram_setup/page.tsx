...
businessName: form.instagram,
subdomain: form.instagram.toLowerCase(),
		...
		<div>
		  ...
		  <p className="text-xs text-gray-500 mt-1">
			...
			<span className="font-medium">
			  {form.instagram || "yourusername"}.simplebookme.com
			</span>
		  </p>
		</div>
        </section>
...
<p><strong>Website:</strong> {form.instagram}.simplebookme.com</p>
